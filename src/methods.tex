...
% to assess overall performance more accurately. The quantification program was run using both the IDIF and AIF as input functions, and the regional metabolic rate of glucose was compared between the two methods.
